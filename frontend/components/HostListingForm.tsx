...
import { useCreateListing, useDeletePhoto, useUpdateListing, useUploadPhoto } from '@/lib/hooks';
...
export function HostListingForm({ listing, onDone }: { listing?: Listing; onDone: () => void }) {
                ...
                <div className='min-w-[min(100%,260px)] flex-[0_1_300px]'>
                    ...
                    <div className='max-w-[300px] overflow-hidden rounded-porch border border-line bg-bg'>
                        ...
                        <div className='grid gap-[3px] px-3.5 pb-3.5 pt-3'>
                            ...
                            <div className='mt-1' style={{ font: '500 14px var(--font-sans)' }}>
...
function Label({ children }: { children: React.ReactNode }) {
    return <div className='mono mb-1.5 text-[9.5px] tracking-[0.14em] text-ink3'>{children}</div>;
}

...
function TripsInner() {
    ...
    return (
        <div className='mx-auto w-full max-w-[860px] px-[clamp(14px,3.5vw,32px)] pb-20 pt-7'>
            ...
            <div className='mb-6 text-[14px] text-ink2' style={{ fontFamily: 'var(--font-sans)' }}>
    ...
    return (
        <div className='relative min-h-[112px] flex-[0_0_clamp(96px,18vw,170px)]'>
            <div
                ...
                style={{
                    background: listing ? coverPhoto(listing).background : 'var(--surface2)',
                }}
            />
        </div>
    );
...
function UpcomingCard({ booking, listing }: { booking: Booking; listing?: Listing }) {
...
function PastCard({ booking, listing }: { booking: Booking; listing?: Listing }) {
    const { user } = useAuth();
    const { toast } = useToast();
    ...
    const submit = () => {
        createReview.mutate(
            ...
            },
            {
                ...
                onError: (e) => toast(e instanceof ApiError ? e.message : "Couldn't submit review"),
            },
        );
    };
        ...
        <div className='overflow-hidden rounded-porch border border-line bg-surface'>
            ...
            {alreadyReviewed ? (
                ...
                <div className='flex flex-wrap items-center justify-between gap-2.5 border-t border-dashed border-line px-4 py-3'>
                    <span style={{ font: '500 13.5px var(--font-sans)' }}>How was your stay?</span>
                    <button
                        type='button'
